<nav class="border-b border-gray-800">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-4">
        ...
        <div class="mx-6 flex items-center">
            @if (Auth::user())
                <div class="ml-4 relative" x-data="{ isOpen : false }" @click.away="isOpen = false">
                    <button class="focus:outline-none">
                        <img @click="isOpen = true" class="rounded-full w-8 h-8" src="https://randomuser.me/api/portraits/women/44.jpg" alt="">
                    </button>

                    <div class="absolute right-0 w-64 bg-gray-800" x-show.transition.opacity="isOpen">
                        <ul
                        ...
                        class="absolute right-0 w-56 p-2 mt-2 space-y-2 bg-gray-800 text-cool-gray-300 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700"
                        aria-label="submenu"
                    >
                        <li class="flex">
                        <a
                            class="border-b border-gray-700 inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                            href="#"
                        >
                            <svg
                            class="w-4 h-4 mr-3"
